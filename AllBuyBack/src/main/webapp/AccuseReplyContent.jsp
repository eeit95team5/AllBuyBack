...
<!-- 引入共同的頁首 -->
  ...
  <form ENCTYPE="multipart/form-data" method="get" action=" <c:url value="/RepController"/>"  id="/ItemController" >
      ...
      <input type="text" name="rep_resultTitle" value="${ReportVO.rep_resultTitle}" class="fieldWidth" style="width: 200px;">
      <font color="red" size="-1">${MsgMap.errorPasswordEmpty}</font>      
      <br/>
      
       <label class="fontSize" >回覆時間：</label>
      <input type="text" name="rep_procssDate" value="${ReportVO.rep_procssDate}" class="fieldWidth" style="width: 200px;">
      <font color="red" size="-1">${MsgMap.errorPasswordEmpty}</font>      
      <br/>
      
      <label class="fontSize" >回覆內容：</label>
      <textarea rows="5" cols="50" name="rep_result" class="fieldWidth" style="width: 200px">${ReportVO.rep_result}</textarea> 
