...
<!-- 引入共同的頁首 -->
  ...
  <form ENCTYPE="multipart/form-data" method="get" action=" <c:url value="/RepController"/>"  id="/ItemController" >
      <label class="fontSize" >申訴編號：</label>
      <input type="text" name="rep_id" value="${ReportVO.rep_id}" class="fieldWidth" style="width: 180px;">
      ...
      <label class="fontSize" >檢舉時間：</label>
      <input type="text" name="rep_date" value="${ReportVO.rep_date}" class="fieldWidth" style="width: 200px;">
      <font color="red" size="-1">${MsgMap.errorPasswordEmpty}</font>      
      <br/>
      
      <label class="fontSize" >檢舉原因：</label>
      <textarea rows="5" cols="50" name="reason" class="fieldWidth" style="width: 200px">${ReportVO.rep_content}</textarea> 
      <font color="red" size="-1">${MsgMap.errorPassword2Empty}</font>            
      <br/>
      
      <label class="fontSize" >回覆標題：</label>
      <input type="text" name="reply_title" value="${ReportVO.rep_resultTitle}" class="fieldWidth" style="width: 200px;">
      <font color="red" size="-1">${MsgMap.errorPasswordEmpty}</font>      
      <br/>
