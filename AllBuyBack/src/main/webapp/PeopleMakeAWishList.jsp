...
<jsp:include page="includeTop.jsp"></jsp:include>
	...
	<a href="CheckYourList"><input class="btn" type="button" value="個人許願池"></a>
	<br>
	<br>
	<table>
		<thead>
		...
		<tbody>
			<c:forEach var="mVO" items="${VOlist}">
				<tr>
					<td id="hId"><a href="PeopleWishContent?w_id=${mVO.w_id}">${mVO.w_id}</a></td>
					<td id="hId">${mVO.m_account}</td>
					<td id="hId">${mVO.w_title}</td>
					<td id="hId"><a href="PeopleWishContent?w_id=${mVO.w_id}">${mVO.w_content}</a></td>
