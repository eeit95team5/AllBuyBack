...
$(function(){
	...
	$('.g2').click(function(){
		...
		$.get("<c:url value='/ItemController'/>",{"action":"ItemListAll"},
				function(data){
			$('#show').html(data)
	...
	$('.g3').click(function(){
		...
		$.get("<c:url value='/ItemController'/>",{"action":"AccusedItemListAll"},
				function(data){
			$('#show').html(data)
	...
	$('.g4').click(function(){
		...
		$.get("<c:url value='/MemController'/>",{"action":"BlackList"},
				function(data){
			$('#show').html(data)
	...
	$('.g5').click(function(){
		...
		$.get("<c:url value='/MemController'/>",{"action":"MallList"},
				function(data){
			$('#show').html(data)
	...
	$('.g6').click(function(){
		...
		$.get("<c:url value='/ShopController'/>",{"action":"MallApply"},
				function(data){
			$('#show').html(data)
	...
	$('.g7').click(function(){
		...
		$.get("<c:url value='/RepController'/>",{"action":"ItemAccuse"},
				function(data){
			$('#show').html(data)
