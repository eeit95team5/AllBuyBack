...
<form action="<c:url value='/item.SPRINGcontroller'/>" method="get">
	<table>
		...
		<tr><td>i_arrivedDate</td><td><input type="text" name="i_arrivedDate" id="i_arrivedDate" value="" /></td><td>${errors.i_arrivedDate}</td></tr>
		<tr><td>i_onSellDate</td><td><input type="text" name="i_onSellDate" id="i_onSellDate"  value="" readonly="readonly"/></td><td>${errors.i_onSellDate}</td></tr>
		...
		<tr><td>i_status</td><td><select id="i_status" name="i_status" <c:if test="${itembean.i_status == 0 }">disabled="disabled"</c:if> >
			...
			<c:if test="${itembean.i_status == 0 }">		
			<option value="0" selected="selected">停權</option>
			</c:if>		
		</select></td><td>${errors.i_status}</td></tr>
		<tr><td>i_class1</td><td><select id="i_class1" name="i_class1"></select></td><td>${errors.i_class1 }</td></tr>
		<tr><td>i_class2</td><td><select id="i_class2" name="i_class2"></select></td><td>${errors.i_class2 }</td></tr>
		<tr><td>i_class3</td><td><select id="i_class3" name="i_class3"></select></td><td>${errors.i_class3 }</td></tr>
		<tr><td>i_popular</td><td><input type="text" name="i_popular" id="i_popular"  value="${itembean.i_popular}" readonly="readonly"/></td><td>${errors.i_popular }</td></tr>
		<tr><td>i_click</td><td><input type="text" name="i_click" id="i_click"  value="${itembean.i_click}" readonly="readonly"/></td><td>${errors.i_click }</td></tr>
		<tr><td>s_class1</td><td><input type="text" name="s_class1" id="s_class1" value="${itembean.s_class1}" /></td><td>${errors.s_class1 }</td></tr>
		<tr><td>s_class2</td><td><input type="text" name="s_class2" id="s_class2" value="${itembean.s_class2}" /></td><td>${errors.s_class2 }</td></tr>
	</table>
...
<div><h4><c:if test="${not empty update }">修改商品成功</c:if>${action }</h4></div>
