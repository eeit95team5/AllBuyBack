...
public class MemVO implements Serializable {
	...
	private Blob m_background;
	private int m_scoreCount;
	private int m_avgScore;
	private Timestamp m_lastUsed;
	private int m_point;
	...
	public Blob getM_background() {
		return m_background;
	}
	public void setM_background(Blob m_background) {
	...
	public Timestamp getM_lastUsed() {
		return m_lastUsed;
	}
	public void setM_lastUsed(Timestamp m_lastUsed) {
